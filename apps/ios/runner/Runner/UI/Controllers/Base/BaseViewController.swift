...
class BaseViewController: UIViewController, NetworkErrorViewProtocol {
    ...
    func setupNavigationBar() {
        ...
        navigationController?.navigationBar.barTintColor = UIColor(hexString: "#F39027")!
        navigationController?.view.backgroundColor = UIColor(hexString: "#F39027")!
    }

    func setupTabBar() {
        tabBarController?.tabBar.backgroundColor = UIColor.white
        tabBarController?.tabBar.tintColor = UIColor(hexString: "#F39027")!
    ...
    @objc func onBackButtonTouchUpInside(button _: UIButton) {
        ...
        if UIHelper.isPresentedViewController(viewController: self) {
